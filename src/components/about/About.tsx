...
`}
    ...
    >
      ...
      />
      <h4 className="mt-8 mb-2 font-semibold text-zinc-700 dark:text-zinc-50 text-[1.1rem]">
        {t("experienceTitle")}
      </h4>
      ...
      <div className="flex mt-4 gap-6">
        <div className="flex flex-col">
          <div className="flex items-end mt-[10px] relative">
            <span className="w-3 h-[2px] bg-primary dark:bg-primaryDark"></span>
            <span className="rounded-full h-3 w-3 absolute border-2 border-primary dark:border-primaryDark -bottom-[5px] left-2.5"></span>
          </div>

          <span className="flex-1 h-full w-[2px] bg-primary dark:bg-primaryDark"></span>
        </div>

        <div>
          <div className="flex mb-2 gap-4 items-end">
            <strong className="font-semibold">DBC Company</strong>
            <span className="text-zinc-500 dark:text-zinc-50 font-medium text-sm">
              {i18n.language === "br" ? "12/2023 - 05/2024" : "Dec 2023 - May 2024"}              
            </span>
          </div>
