    ...
    <aside className="flex fixed w-full h-full ">
      <div className="flex flex-col justify-between h-full pt-28 pb-10 max-h-[680px]">
        ...
        <div className="flex justify-between items-end">
          ...
          <label
            htmlFor="toogleLang"
            className="flex items-center gap-3 cursor-pointer select-none text-dark dark:text-white"
          >
            ...
            <div className="relative">
              ...
              />
              <div className="h-5 rounded-full shadow-inner bg-gray-200 w-14"></div>
              <div className="absolute left-0 transition bg-primary rounded-full dot shadow-switch-1 dark:bg-dark-4 -top-1 h-7 w-7 peer-checked:translate-x-full"></div>
            </div>
          </label>
        </div>
      </div>
